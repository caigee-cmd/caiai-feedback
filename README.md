...
- 如发现安全漏洞，请不要直接发公开 Issue，请优先发送邮件至 **security@caiai.example.com**（请替换为真实邮箱）。

## 相关链接

- 🌐 CaiAI 官网：[https://caiai.example.com](https://caiai.example.com)（请替换为真实地址）
- 📧 客服支持：[support@caiai.example.com](mailto:support@caiai.example.com)（请替换为真实邮箱）
- 🛡️ 安全报告：[security@caiai.example.com](mailto:security@caiai.example.com)（请替换为真实邮箱）
